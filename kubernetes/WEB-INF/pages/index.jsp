        ...
        <nav class="navbar navbar-default navbar-fixed-top">
          <div class="container" id="navbar">
                            ...
                            <div class="navbar-header page-scroll">
                             ...
                             <!--   Modifier le nom ci-dessous (celui qui apparait en haut à gauche dans la barre de navigation)  -->
                                
                                <a class="navbar-brand" href="#" id="brand">Copefrito</a>
                            </div>
                            ...
                            <div class="collapse navbar-collapse" id="collapse-menu">
                                <ul class="nav navbar-nav navbar-right">
                                  ...
                                  <!--  CI-DESSOUS POUR CHANGER LES RUBRIQUES :  ACCUEIL - SERVICES - CONTACT -->
                                    
                                    <li class="page-scroll">
                                        <a href="#mainsection">Accueil</a>
                                    </li>
                                    <li class="page-scroll">
                                ...
                                <div class="intro-message">
                                    <
                                      ...
                                      <!--        LIEN VERS FENETRE AVEC VIDEO YOUTUBE (OPTION)-->
                                       ...
                                       <!-- Large modal -->
                 <!--    <button type="button" class="btn btn-default btn-lg" data-toggle="modal" data-target="#youtube-modal"> <strong>1 vidéo &#62; 1k mots </strong></button> -->
                        ...
                        <div class="container">
                                ...
                                <div class="footer-col col-md-6 text-center">
                                    <h1>Nous rendre visite</h1>
                                              <address>
                                                  <strong>Copefrito</strong><br>
                                                  Avenue de France / Mahavatse<br>
                                                  Tulear 601, Madagascar/BP : 212<br>
                                                  Tel: (+261) 20 944 3802
                                                </address>

                                                <address>
                                                  <strong>Copefrito</strong><br>
                                                  <a href="mailto:#">info@copefrito.com</a>
                                            </address>
                                </div>
                                <div class="footer-col col-md-6 text-center">
                                    <h1>Nous suivre</h1>
                                    <ul class="list-inline ">
                                        ...
                                        <li>
                                            <a href="https://mg.linkedin.com/company/copefrito" class="btn-social btn-outline"><i class="fa fa-2x fa-linkedin"></i></a>
                                        </li>
                                        <li>
                                            <a href="https://www.facebook.com/copefrito/" class="btn-social btn-outline"><i class="fa fa-2x fa-facebook"></i></a>
                                        </li>
                                        <li>
                                            <a href="#" class="btn-social btn-outline"><i class="fa fa-2x fa-twitter"></i></a>
                                        </li>
                                        <li>
                                            <a href="#" class="btn-social btn-outline"><i class="fa fa-2x  fa-vine"></i></a>
                                        </li>
                                    </ul>
                                </div>
    ...
    <footer class="navbar navbar-default navbar-static-bottom text-center" id="footer">
                                ...
                                <div class="col-lg-12">
                                      ...
                                      <!--       CI-DESSOUS POUR CHANGER LE COPYRIGHT-->
                                              ...
                                              <p> <strong>&copy; Copefrito - 2023 </strong> </p>
                                </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header text-center">
        ...
        <h4 class="modal-title" id="myModalLabel"><strong>Frugal Solution en vidéo</strong></h4>
      </div>
      <div class="modal-body">
                                                  ...
                                                  <iframe class="embed-responsive-item" src="http://www.youtube.com/embed/A7E0raKTsZA?feature=oembed"></iframe>
                                                </div>
                                                  </div>
